...
namespace dx3d {
    namespace physics {
        ...
        public:
            ...
            // Convert dx3d::AABB to physics::AABB
            static AABB toPhysicsAABB(const dx3d::AABB& aabb) {
                return AABB(aabb);
            }

            // Convert physics::AABB to dx3d::AABB
            static dx3d::AABB toEngineAABB(const AABB& aabb) {
                return aabb.toAABB();
            }
