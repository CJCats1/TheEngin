...
namespace TheEngine
{
	...
	{
	public:
		explicit OpenGLContext(Logger& logger);
		...
		void setLights(const std::vector<Vec3>& dirs, const std::vector<Vec3>& colors,
	...
	private:
		...
		unsigned int m_indexType{ 0 };
		unsigned int m_program{};
#endif
		Mat4 m_worldMatrix{};
		Mat4 m_viewMatrix{};
		Mat4 m_projectionMatrix{};
		Vec4 m_tint{ 1.0f, 1.0f, 1.0f, 0.0f };
	};
}
