...
namespace TheEngine {
    ...
    private:
        ...
        // Physics AABBs
        TheEngine::physics::AABB m_playerBox;
        std::vector<TheEngine::physics::AABB> m_staticBoxes;
        Vec2 m_playerVelocity;

        // Dynamic AABBs with gravity
        std::vector<TheEngine::physics::AABB> m_dynamicBoxes;
        ...
        std::vector<TheEngine::physics::CircleBody> m_circles;
